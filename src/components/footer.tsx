const navigation = {
    ...
    social: [
      {
        name: 'Instagram',
        href: 'https://www.instagram.com/jayko_001/',
        icon: (props: any) => (
      ...
      {
        name: 'GitHub',
        href: 'https://github.com/Jayko001',
        icon: (props: any) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
              fillRule="evenodd"
      ...
      {
        name: 'LinkedIn',
        href: 'https://www.linkedin.com/in/jayko001/',
        icon: (props: any) => (
      ...
      {
        name: 'Email',
        href: 'mailto:kotharjy@mail.uc.edu?subject=Hello%20Jay!',
        icon: (props: any) => (
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path 
              fillRule="evenodd"
  ...
  export default function Footer() {
    return (
      <footer className="bg-gray-800  bottom-0 z-10 font-tektur">
        <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-12 lg:px-8">
          ...
          <p className="mt-10 text-center text-xs leading-5 text-gray-500">
            &copy; 2023 Jay Kothari. All rights reserved.
          </p>
        </div>
      </footer>
    )
